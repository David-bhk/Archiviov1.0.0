...
- SQLite reste la source active tant que les parcours applicatifs n'ont pas été validés sur PostgreSQL. La base PostgreSQL locale contient une copie contrôlée et vérifiée, mais ne reçoit encore aucune écriture de l'application.
